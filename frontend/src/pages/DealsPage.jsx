        ...
        <div style={{
          ...
          >
            <svg width="38" height="38" viewBox="0 0 240 240" xmlns="http://www.w3.org/2000/svg">
              ...
              <path fill="white" d="M175.5 75.4L152.8 174.3c-1.7 7.5-6.1 9.4-12.4 5.8l-34.2-25.2-16.5 15.9c-1.8 1.8-3.4 3.4-6.9 3.4l2.5-34.9L152 99.6c2.9-2.6-.6-4-4.5-1.4L74.7 148.5 41 138.1c-7.3-2.3-7.5-7.3 1.5-10.8l122.6-47.3c6.1-2.3 11.4 1.5 10.4 10.4z"/>
            </svg>
          </a>
          {/* Theme toggle */}
          <button
